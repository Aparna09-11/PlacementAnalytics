...
const ContactPage = () => {
  ...
  return (
    <div className='main'>
      ...
      <h2>Email</h2>
      <p>For general inquiries, please email us at <a href="mailto:info@placementanalytics.com">info@placementanalytics.com</a>.</p>

      <h2>Phone</h2>
      <p>You can also reach us by phone at 555-123-4567. Our office hours are Monday to Friday, 9am to 5pm EST.</p>
